...
zooAnimals.forEach(function(zoo) {
  displayNames.push(`names: ${zoo.animal_name}, scientific: ${zoo.scientific_name}`)
...
zooAnimals.map(function(animalName) {
...
zooAnimals.filter(function(zoo){
  return zoo.lowPopulationAnimals < 5;
})
...
zooAnimals.reduce(function(animals, population, cb){
return cb(animals, population);
})
